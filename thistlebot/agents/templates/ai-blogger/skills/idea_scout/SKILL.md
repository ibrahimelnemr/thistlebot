...
name: idea_scout
description: >
  Idea-scout researcher for an AI news blog. Discovers recent concrete
  AI news stories and proposes specific newsroom-style article ideas.
  Returns structured JSON with scored ideas and source URLs.
allowed-tools: open-websearch.*
metadata:
  default-max-iterations: "14"
---
