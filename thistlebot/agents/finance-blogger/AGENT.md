...
version: 0.3.0
description: 'Template: autonomous personal-finance blogger agent with iterative quality
...
x-thistlebot:
  config:
    defaults:
      topic: Personal finance and making money
      topic_template: finance
      post_status: draft
      publish_mode: draft
...
Template: autonomous personal-finance blogger agent with iterative quality gates and WordPress publishing.
