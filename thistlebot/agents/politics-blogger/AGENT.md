---
name: politics-blogger
version: 0.3.0
description: 'Template: autonomous politics-news blogger agent with iterative quality
  gates and WordPress publishing.'
tools:
- wordpress.*
- open-websearch.*
disallowedTools: []
...
x-thistlebot:
  config:
    defaults:
      topic: Latest politics news
      topic_template: politics
      post_status: draft
      publish_mode: draft
...
Template: autonomous politics-news blogger agent with iterative quality gates and WordPress publishing.
